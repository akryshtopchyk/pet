  ...
  getStops() {
    return {
      ...
      fromMoskvaToPinsk: [
        ...
        { id: 6, name: 'Телеханы (автовокзал)', time: 710 },
        { id: 7, name: 'Логишин', time: 740 },
        { id: 8, name: 'Пинск кВт', time: 770 },
        { id: 9, name: 'Пинск жд вокзал', time: 780 },
      ],
      toMoskvaFromPinsk: [
        { id: 1, name: 'Москва (автовокзал саларьево)', time: 0 },
        { id: 2, name: 'Минск (метро Могилевская)', time: 490 },
      ...
      fromPinskToMoskva: [
        ...
        { id: 6, name: 'Барановичи(корона)', time: 170 },
        { id: 7, name: 'Минск(метро Малиновка)', time: 270 },
        { id: 8, name: 'Минск (метро Могилевская)', time: 290 },
        { id: 9, name: 'Москва (автовокзал саларьево)', time: 780 },
      ],
      toPinskFromMoskva: [
        { id: 1, name: 'Пинск жд вокзал', time: 0 },
        { id: 2, name: 'Пинск кВт', time: 10 },
